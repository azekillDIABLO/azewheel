...
function bike.on_punch(self, puncher, time_from_last_punch,
	...
	if not self.driver then
		...
		if not minetest.setting_getbool("creative_mode") then
			puncher:get_inventory():add_item("main", "azewheel:bike")
		end
	end
end
...
minetest.register_entity("azewheel:bike", bike)


minetest.register_craftitem("azewheel:bike", {
	description = "bike",
	...
	on_place = function(itemstack, placer, pointed_thing)
		...
		minetest.add_entity(pointed_thing.under, "azewheel:bike")
		if not minetest.setting_getbool("creative_mode") then
			itemstack:take_item()
		end
		return itemstack
